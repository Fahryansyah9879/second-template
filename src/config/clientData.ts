...
export const clientData = {
  ...
  testimonials: [
    {
      quote:
        "Eleanor captured our day with such grace and artistry. Every photograph feels like a page from a beautiful storybook. We couldn't be more grateful.",
      couple: 'Sarah & James',
      location: 'Lake Como, Italy',
    },
    {
      quote:
        "The way she captured the light, the emotion, the tiny details we didn't even notice—it's absolutely magical. These photos are our most treasured possessions.",
      couple: 'Victoria & Alexander',
      location: 'The Plaza, New York',
    },
    {
      quote:
        'Working with Eleanor was a dream. She made us feel so comfortable, and the results exceeded every expectation. Pure artistry.',
  ...
  services: [
    {
      ...
      description:
        'Complete documentation from preparation to the last dance, ensuring no moment goes uncaptured.',
    },
    {
      title: 'Engagement Sessions',
      description:
        'An intimate portrait session to celebrate your journey and create stunning save-the-date imagery.',
    },
    {
      title: 'Destination Weddings',
      description:
        "Specialized in capturing love stories at the world's most breathtaking locations.",
    },
    {
      title: 'Albums & Fine Prints',
      description:
        'Heirloom-quality albums and museum-grade prints to treasure for generations.',
    },
  ],
  ...
  cta: {
    ...
    subtext:
      "Your wedding day is a once-in-a-lifetime celebration. Let's ensure every precious moment is captured with the artistry and care it deserves.",
